...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * (i.e. "mostrando 1 en 10 de 57 entradas") DataTables will render large numbers
		...
		"oLanguage": {
			 ...
			 *
			 *  @type string
			 *  @default mostrando _START_ en _END_ de _TOTAL_ entradas
			 *
			 *  @dtopt Language
			 ...
			 *  @type string
			 *  @default mostrando 0 en 0 de 0 entradas
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Filtrando _MAX_ del total entradas)",
