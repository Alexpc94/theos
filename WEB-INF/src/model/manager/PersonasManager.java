...
public class PersonasManager {
	...
	public List<Personal> listarPersonal(int xact1, int xact2,int xactivos){
		String xsql="  select  codper,codigoper,nombre,ap,am,estado,fingreso,fnac,genero,ecivil,email,cicli,cliente,max(cedula) as cedula, max(nomsocio) as nomsocio,max(codes) as codes, max(activo) as activo,max(mesini) as mesini,max(anioini) as anioini  " 
				+"	from (  "
				+" 	 select p.codper,p.codigoper,p.nombre,p.ap,p.am,p.estado,p.fnac,p.fingreso,p.genero,p.ecivil,p.email,df.ci as cicli,df.cliente,dat2.cedula as cedula,0 as codes, '-' as nomsocio, p.activo,p.mesini,p.anioini  " 
				...
				+"  UNION ALL 				"
				+"	   select p.codper,p.codigoper,p.nombre,p.ap,p.am,p.estado,p.fnac,p.fingreso,p.genero,p.ecivil,p.email,df.ci as cicli,df.cliente,'-' as cedula,dat2.codes,dat2.nombre as nomsocio, p.activo,p.mesini,p.anioini  "  
				+"	   from datosfac df, personal p, (   "
...
//	                    per.setLogin(rs.getString("login"));
	...
	public String setActivarSocio(int xcodper,Date xfecha,int xmes,int xanio,String xlogin,int xopcion){
		return this.jdbcTemplate.queryForObject("select activar_socio(?,?,?,?,?,?)", String.class,new Object[] {xcodper,xfecha,xmes,xanio,xlogin,xopcion});
	}
	...
	public String setAddPersonal(String ci,int codigoper,String nombre,String ap,String am,String email,String ecivil,String genero, Date fechaNac, Date fechaIng,String cliente,int xconyuge){
		return this.jdbcTemplate.queryForObject("select addPersona(?,?,?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {ci,codigoper,nombre,ap,am,email,ecivil,genero,fechaNac,fechaIng,cliente,xconyuge});
	}
	public String setModPersonal(String ci,int codper,String nombre,String ap,String am,String email,String ecivil,String genero, Date fechaNac, Date fechaIng,int xconyuge,int xcodigoper){
		return this.jdbcTemplate.queryForObject("select modPersona(?,?,?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {ci,codper,nombre,ap,am,email,ecivil,genero,fechaNac,fechaIng,xconyuge,xcodigoper});
	}
	public String setModFacPersonal(String ci,int codper,String nombre){
		return this.jdbcTemplate.queryForObject("select modFacPersona(?,?,?)", String.class,new Object[] {ci,codper,nombre});
	}
	...
	//extrae UN OBJETO de dirdom
		...
		public String setAddDomicilio(int codper,int codl,String zona,String calle,String numero,String edificio,String bloque,String telefono,String celular, String email){
			return this.jdbcTemplate.queryForObject("select addDomicilio(?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codl,zona,calle,numero,edificio,bloque,telefono,celular,email});
		}
		public String setModDomicilio(int codper,int codl,String zona,String calle,String numero,String edificio,String bloque,String telefono,String celular, String email){
			return this.jdbcTemplate.queryForObject("select modDomicilio(?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codl,zona,calle,numero,edificio,bloque,telefono,celular,email});
		}
		...
		//extrae UN OBJETO de dirtrab
				...
				public String setAddTrabajo(int codper,int codl,String empresa,String cargo,String zona,String calle,String numero,String edificio,String bloque,String telefono,String celular, String email){
					return this.jdbcTemplate.queryForObject("select addTrabajo(?,?,?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codl,empresa,cargo,zona,calle,numero,edificio,bloque,telefono,celular,email});
				}
				public String setModTrabajo(int codper,int codl,String empresa,String cargo,String zona,String calle,String numero,String edificio,String bloque,String telefono,String celular, String email){
					return this.jdbcTemplate.queryForObject("select modTrabajo(?,?,?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codl,empresa,cargo,zona,calle,numero,edificio,bloque,telefono,celular,email});
				}
			...
			/*
			  ...
			  public List<Map<String,Object>> listarPersonal_estado(int xcodper){
				String xsql=" 	select e.codper,e.codes,e.fecha,e.estado,e.sw, s.nombre as nomestado,s.cuota"
						+"	  	from estado e, estadosoc s "
			...
			*/
				...
				public String setAddEstados(int codper,int codes, Date fechaest,int sw,String xlogin,int mesini,int anioini,int mesfin,int aniofin, int xpermiso){
					return this.jdbcTemplate.queryForObject("select addEstado(?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codes,fechaest,sw,xlogin,mesini,anioini,mesfin,aniofin,xpermiso});
				}
				public String setModEstados(int codper,int codcodestado,int Actcodes, Date fechaest,String xlogin,int mesini,int anioini,int mesfin,int aniofin,int xpermiso){
					return this.jdbcTemplate.queryForObject("select modEstado(?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {codper,codcodestado,Actcodes,fechaest,xlogin,mesini,anioini,mesfin,aniofin,xpermiso});
				}
				...
				public String setAddBeneficiario(String ci,int codigoper,String nombre,String ap,String am,String email,String ecivil,String genero, Date fechaNac, Date fechaIng,int padrecodper,int benef,int xconyuge){
					return this.jdbcTemplate.queryForObject("select addBeneficiario(?,?,?,?,?,?,?,?,?,?,?,?,?)", String.class,new Object[] {ci,codigoper,nombre,ap,am,email,ecivil,genero,fechaNac,fechaIng,padrecodper,benef,xconyuge});
				}
				...
				public String setAddAntiguedad(int codper,int codes, Date fechaest){
					return this.jdbcTemplate.queryForObject("select addAntiguedad(?,?,?)", String.class,new Object[] {codper,codes,fechaest});
				}
